  ...
  describe('Plugger(name: string)', () => {
    ...
    describe('#getLoadOrder()', () => {
      it('should return the correct load order with undefined priorities', () => {
        ...
        [...plugins, child4].forEach((plugin) => { parent.addPlugin(plugin); });
      ...
      it('should return the correct load order with default priorities', () => {
        ...
        [child1, child2, child3, child4].forEach((plugin) => { parent.addPlugin(plugin); });

        const expectedLoadOrder = [
          child2.metadata.name, child3.metadata.name, child1.metadata.name, child4.metadata.name,
        ];
